 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/core_blas/core_ztslqt.c, normal z -> s, Fri Sep 28 17:38:24 2018
 *
 **/
                ...
                float *work)
{
    ...
    for (int ii = 0; ii < m; ii += ib) {
        ...
        if (m > ii+sb) {
            plasma_core_stsmlq(PlasmaRight, PlasmaTrans,
                     ...
                     plasma_sequence_t *sequence, plasma_request_t *request)
{
                                           ...
                                           // as ibxm
    {
        if (sequence->status == PlasmaSuccess) {
            ...
            // Call the kernel.
            int info = plasma_core_stslqt(m, n, ib,
                                   A1, lda1,
                                   A2, lda2,
                                   T,  ldt,
                                   tau,
