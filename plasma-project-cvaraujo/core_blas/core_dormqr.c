 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/core_blas/core_zunmqr.c, normal z -> d, Fri Sep 28 17:38:25 2018
 *
 **/
 ...
 *        Q = H(1) H(2) ... H(k)
 *    \f]
 *  as returned by plasma_core_dgeqrt. Q is of order m if side = PlasmaLeft
 ...
 *         as returned by plasma_core_dgeqrt in the first k columns of its
 *         array argument A.
 *
 * @param[in] lda
                     ...
                     plasma_sequence_t *sequence, plasma_request_t *request)
{
                     ...
                     depend(inout:C[0:ldc*n])
    {
        if (sequence->status == PlasmaSuccess) {
            ...
            // Call the kernel.
            int info = plasma_core_dormqr(side, trans,
                                   m, n, k, ib,
                                   A, lda,
                                   T, ldt,
                                   C, ldc,
