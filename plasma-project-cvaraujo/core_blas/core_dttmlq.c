 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/core_blas/core_zttmlq.c, normal z -> d, Fri Sep 28 17:38:25 2018
 *
 **/
 ...
 *    Q = H(k)^T . . . H(2)^T H(1)^T
 *
 *  as returned by plasma_core_dttlqt.
 *
 *******************************************************************************
 *
 * @param[in] side
 ...
 *         plasma_core_dttlqt in the first k rows of its array argument V.
 *
 * @param[in] ldv
                     ...
                     plasma_sequence_t *sequence, plasma_request_t *request)
{
                     ...
                     depend(in:T[0:ib*k])
    {
        if (sequence->status == PlasmaSuccess) {
            ...
            // Call the kernel.
            int info = plasma_core_dttmlq(side, trans,
                                   m1, n1, m2, n2, k, ib,
                                   A1, lda1,
                                   A2, lda2,
                                   V,  ldv,
