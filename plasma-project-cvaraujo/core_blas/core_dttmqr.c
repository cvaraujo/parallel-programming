 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/core_blas/core_zttmqr.c, normal z -> d, Fri Sep 28 17:38:25 2018
 *
 **/
 ...
 *    Q = H(1) H(2) . . . H(k)
 *
 *  as returned by plasma_core_dttqrt.
 *
 *******************************************************************************
 *
 * @param[in] side
 ...
 *         plasma_core_dttqrt in the first k columns of its array argument V.
 *
 * @param[in] ldv
                      ...
                      double *work, int ldwork)
{
    ...
    for (int i = i1; i > -1 && i < k; i += i3) {
        ...
        // Apply H or H^T (NOTE: plasma_core_dparfb used to be core_zttrfb).
                     ...
                     plasma_sequence_t *sequence, plasma_request_t *request)
{
                     ...
                     depend(in:T[0:ib*k])
    {
        if (sequence->status == PlasmaSuccess) {
            ...
            // Call the kernel.
            int info = plasma_core_dttmqr(side, trans,
                                   m1, n1, m2, n2, k, ib,
                                   A1, lda1,
                                   A2, lda2,
                                   V,  ldv,
