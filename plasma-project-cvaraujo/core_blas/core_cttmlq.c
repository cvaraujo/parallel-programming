 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/core_blas/core_zttmlq.c, normal z -> c, Fri Sep 28 17:38:25 2018
 *
 **/
 ...
 *    Q = H(k)^H . . . H(2)^H H(1)^H
 *
 *  as returned by plasma_core_cttlqt.
 *
 *******************************************************************************
 *
 * @param[in] side
 ...
 *         plasma_core_cttlqt in the first k rows of its array argument V.
 *
 * @param[in] ldv
                     ...
                     plasma_sequence_t *sequence, plasma_request_t *request)
{
                     ...
                     depend(in:T[0:ib*k])
    {
        if (sequence->status == PlasmaSuccess) {
            ...
            // Call the kernel.
            int info = plasma_core_cttmlq(side, trans,
                                   m1, n1, m2, n2, k, ib,
                                   A1, lda1,
                                   A2, lda2,
                                   V,  ldv,
