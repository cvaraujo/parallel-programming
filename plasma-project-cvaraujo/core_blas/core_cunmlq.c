 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/core_blas/core_zunmlq.c, normal z -> c, Fri Sep 28 17:38:25 2018
 *
 **/
 ...
 *        Q = H(k) . . . H(2) H(1)
 *    \f]
 *  as returned by plasma_core_cgelqt. Q is of order m if side = PlasmaLeft
 ...
 *         plasma_core_cgelqt in the first k rows of its array argument A.
 *
 * @param[in] lda
                     ...
                     plasma_sequence_t *sequence, plasma_request_t *request)
{
                     ...
                     depend(inout:C[0:ldc*n])
    {
        if (sequence->status == PlasmaSuccess) {
            ...
            // Call the kernel.
            int info = plasma_core_cunmlq(side, trans,
                                   m, n, k, ib,
                                   A, lda,
                                   T, ldt,
                                   C, ldc,
