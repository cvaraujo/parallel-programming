 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/core_blas/core_zparfb.c, normal z -> s, Fri Sep 28 17:38:25 2018
 *
 **/
 ...
 ******************************************************************************/
__attribute__((weak))
int plasma_core_sparfb(plasma_enum_t side, plasma_enum_t trans,
                      ...
                      float *work, int ldwork)
{
    ...
    if (direct == PlasmaForward) {
        ...
        if (side == PlasmaLeft) {
            ...
            // W = A1 + op(V) * A2
            plasma_core_spamm(PlasmaW, PlasmaLeft, storev,
                       k, n1, m2, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
            ...
            // A2 = A2 - op(V) * W
            // W = V * W, A2 = A2 - W
            plasma_core_spamm(PlasmaA2, PlasmaLeft, storev,
                       m2, n2, k, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
        ...
        //==============================
            ...
            // W = A1 + A2 * op(V)
            plasma_core_spamm(PlasmaW, PlasmaRight, storev,
                       m1, k, n2, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
            ...
            // A2 = A2 - W * op(V)
            // W = W * V^T, A2 = A2 - W
            plasma_core_spamm(PlasmaA2, PlasmaRight, storev,
                       m2, n2, k, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
