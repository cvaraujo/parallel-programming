 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/core_blas/core_ztsmlq.c, normal z -> s, Fri Sep 28 17:38:24 2018
 *
 **/
 ...
 *    Q = H(k)^T . . . H(2)^T H(1)^T
 *
 *  as returned by plasma_core_stslqt.
 *
 *******************************************************************************
 *
 * @param[in] side
 ...
 *         plasma_core_stslqt in the first k rows of its array argument V.
 *
 * @param[in] ldv
                      ...
                      float *work, int ldwork)
{
    ...
    for (int i = i1; i > -1 && i < k; i += i3) {
        ...
        // Apply H or H^T.
        plasma_core_sparfb(side, trans, PlasmaForward, PlasmaRowwise,
                    mi, ni, m2, n2, kb, 0,
                    &A1[lda1*jc+ic], lda1,
                    A2, lda2,
                    &V[i], ldv,
                     ...
                     plasma_sequence_t *sequence, plasma_request_t *request)
{
                     ...
                     depend(in:T[0:ib*k])
    {
        if (sequence->status == PlasmaSuccess) {
            ...
            // Call the kernel.
            int info = plasma_core_stsmlq(side, trans,
                                   m1, n1, m2, n2, k, ib,
                                   A1, lda1,
                                   A2, lda2,
                                   V,  ldv,
