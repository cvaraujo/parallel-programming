 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/core_blas/core_zlacpy_band.c, normal z -> s, Fri Sep 28 17:38:19 2018
 *
 **/
 ...
 * @ingroup core_float
 *
 *  plasma_core_slacpy copies a sub-block A of a band matrix stored in LAPACK's band format
                                            ...
                                            float *B, int ldb)
{
    ...
    plasma_core_slacpy_lapack2tile_band(uplo,
                                 it, jt, m, n, nb, kl, ku,
                                 A, lda,
                                 B, ldb);
}
 ...
 * @ingroup core_float
 *
 *  plasma_core_slacpy copies all or part of a two-dimensional matrix A to another
 *  matrix B
 *
 *******************************************************************************
 *
                                            ...
                                            float *A, int lda)
{
    ...
    plasma_core_slacpy_tile2lapack_band(uplo,
                                 it, jt, m, n, nb, kl, ku,
                                 B, ldb,
                                 A, lda);
}
