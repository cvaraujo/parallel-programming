 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/test/test_zlangb.c, normal z -> c, Fri Sep 28 17:38:29 2018
 *
 **/
...
void test_clangb(param_value_t param[], bool run)
{
    ...
    if (test) {
        ...
        float valueRef =
            LAPACK_clangb(&normc, &n, &kl, &ku, ABref+kl, &ldab, work);
