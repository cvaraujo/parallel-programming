 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/test/test_zcgbsv.c, mixed zc -> ds, Fri Sep 28 17:38:26 2018
 *
 **/
...
void test_dsgbsv(param_value_t param[], bool run)
{
    ...
    int plainfo = plasma_dsgbsv(n, kl, ku, nrhs, AB, ldab, ipiv,
                                B, ldb, X, ldx, &ITER);
