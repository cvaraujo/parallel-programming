 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/test/test_zlangb.c, normal z -> d, Fri Sep 28 17:38:29 2018
 *
 **/
...
void test_dlangb(param_value_t param[], bool run)
{
    ...
    if (test) {
        ...
        double valueRef =
            LAPACK_dlangb(&normc, &n, &kl, &ku, ABref+kl, &ldab, work);
