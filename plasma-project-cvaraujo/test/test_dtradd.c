 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/test/test_ztradd.c, normal z -> d, Fri Sep 28 17:38:32 2018
 *
 **/
...
void test_dtradd(param_value_t param[], bool run)
{
    ...
    //================================================================
    // Test results by comparing to result of plasma_core_dtradd function
    //================================================================
    if (test) {
