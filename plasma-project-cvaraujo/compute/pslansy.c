 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/compute/pzlansy.c, normal z -> s, Fri Sep 28 17:38:13 2018
 *
 **/
                    ...
                    plasma_sequence_t *sequence, plasma_request_t *request)
{
    ...
    case PlasmaInfNorm:
        for (int m = 0; m < A.mt; m++) {
            ...
            plasma_core_omp_slansy_aux(PlasmaOneNorm, uplo,
                                mvam,
                                A(m, m), ldam,
                                &work[A.n*m+m*A.nb],
                                sequence, request);
