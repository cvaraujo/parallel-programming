 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/compute/pzunmlq_tree.c, normal z -> s, Fri Sep 28 17:38:15 2018
 *
 **/
        ...
        for (int iop = 0; iop < num_operations; iop++) {
            ...
            if (kernel == PlasmaGeKernel) {
                ...
                for (int n = 0; n < B.nt; n++) {
                    ...
                    plasma_core_omp_sormlq(side, trans,
                                    mvbk, nvbn,
                                    imin(mvaj, nvak), ib,
                                    A(j, k), ldaj,
                                    T(j, k), T.mb,
