 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/compute/pzdesc2tr.c, normal z -> s, Fri Sep 28 17:38:16 2018
 *
 **/
                      ...
                      plasma_request_t *request)
{
    ...
    for (int m = 0; m < A.mt; m++) {
        ...
        for (int n = n_start; n < n_end; n++) {
            ...
            float *bdl =
                (float*)plasma_tile_addr(A, m, n);

            plasma_core_omp_slacpy(PlasmaGeneral, PlasmaNoTrans,
                            y2-y1, x2-x1,
                            &(bdl[x1*A.nb+y1]), ldt,
                            &(f77[x1*lda+y1]), lda,
                            sequence, request);
