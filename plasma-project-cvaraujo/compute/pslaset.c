 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/compute/pzlaset.c, normal z -> s, Fri Sep 28 17:38:13 2018
 *
 **/
        ...
        for (j = 0; j < A.nt; j++) {
            ...
            if (uplo == PlasmaGeneral ||
               ...
               (uplo == PlasmaUpper && i <= j))
                plasma_core_omp_slaset(i == j ? uplo : PlasmaGeneral,
