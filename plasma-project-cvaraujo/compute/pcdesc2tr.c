 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/compute/pzdesc2tr.c, normal z -> c, Fri Sep 28 17:38:16 2018
 *
 **/
    ...
    for (int m = 0; m < A.mt; m++) {
        ...
        for (int n = n_start; n < n_end; n++) {
            ...
            plasma_complex32_t *bdl =
                (plasma_complex32_t*)plasma_tile_addr(A, m, n);
