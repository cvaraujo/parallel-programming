 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/compute/pzunglq_tree.c, normal z -> c, Fri Sep 28 17:38:15 2018
 *
 **/
    ...
    for (int iop = num_operations-1; iop >= 0; iop--) {
        ...
        if (kernel == PlasmaGeKernel) {
            ...
            for (int m = j; m < Q.mt; m++) {
                ...
                plasma_core_omp_cunmlq(PlasmaRight, PlasmaNoTrans,
                                mvqm, nvqk,
                                imin(mvaj, nvak), ib,
                                A(j, k), ldaj,
                                T(j, k), T.mb,
