 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/compute/pzlanhe.c, normal z -> c, Fri Sep 28 17:38:13 2018
 *
 **/
                    ...
                    plasma_sequence_t *sequence, plasma_request_t *request)
{
    ...
    case PlasmaMaxNorm:
        for (int m = 0; m < A.mt; m++) {
            ...
            plasma_core_omp_clanhe(PlasmaMaxNorm, uplo,
                            mvam,
                            A(m, m), ldam,
                            &stub, &work[A.mt*m+m],
                            sequence, request);
    ...
    case PlasmaInfNorm:
        for (int m = 0; m < A.mt; m++) {
            ...
            plasma_core_omp_clanhe_aux(PlasmaOneNorm, uplo,
                                mvam,
                                A(m, m), ldam,
                                &work[A.n*m+m*A.nb],
                                sequence, request);
