 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/compute/pzdesc2pb.c, normal z -> s, Fri Sep 28 17:38:16 2018
 *
 **/
                      ...
                      plasma_request_t *request)
{
    ...
    for (int n = 0; n < A.nt; n++)
    {
        ...
        for (int m = m_start; m <= m_end; m++)
        {
            ...
            plasma_core_omp_slacpy_tile2lapack_band(
                   A.uplo, m, n,
