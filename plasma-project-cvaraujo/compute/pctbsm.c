 ...
 *
 * @generated from /home/luszczek/workspace/plasma/bitbucket/plasma/compute/pztbsm.c, normal z -> c, Fri Sep 28 17:38:14 2018
 *
 **/
                ...
                for (int k = 0; k < B.mt; k++) {
                    ...
                    for (int n = 0; n < B.nt; n++) {
                        ...
                        if (ipiv != NULL) {
                            ...
                            #pragma omp taskwait
                            if (sequence->status == PlasmaSuccess) {
                                plasma_core_cgeswp(PlasmaRowwise, view, k*A.nb+1, k*A.nb+mvbk, ipiv, 1);
                            }
                        }
                        plasma_core_omp_ctrsm(
                            side, uplo, trans, diag,
